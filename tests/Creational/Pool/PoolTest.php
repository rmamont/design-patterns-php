...
class PoolTest extends PHPUnit_Framework_TestCase
{
    ...
    public function testCountFreeAndOccupiedWorkers()
    {
        ...
        $this->assertEquals(0, $pool->getCountFreeWorkers(), 'Now pool have no free workers.');
    }
    ...
    public function testPerformancePoolPattern()
    {
        ...
        /**
         * Start initialization new workers with timer
         */
        ...
        $timeWithOutInitial = $finish - $start;

        $this->assertGreaterThan($timeWithOutInitial, $timeWithInitial, 'Time initialization workers longer than the time without initialization.');
    }
